...
Env vars required:
    ...
    KYTRAN_AUTH_URL        — ARCHIE hub URL (e.g., "http://192.168.1.200:3000")
...
class KytranAuth:
    ...
    def init_app(self, app):
        ...
        self.auth_url = app.config.get("KYTRAN_AUTH_URL") or os.environ.get("KYTRAN_AUTH_URL", "http://192.168.1.200:3000")
