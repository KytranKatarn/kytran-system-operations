"""Subscription service — tier resolution and feature gating for KSO."""
...
# ---------------------------------------------------------------------------
# Tier hierarchy — staff is internal Kytran team (above enterprise)
# ---------------------------------------------------------------------------
TIER_LEVELS = {"free": 0, "pro": 1, "business": 2, "enterprise": 3, "staff": 4}

# Actual pack IDs matching the compliance_rule_packs table
ALL_PACKS = [
    "cis-ubuntu-22.04", "ubuntu-22.04-stig", "network-stig",
    "docker-stig", "hipaa-security",
]
...
TIER_PACKS = {
    "free": ["network-stig"],
    "pro": ["network-stig", "ubuntu-22.04-stig", "cis-ubuntu-22.04"],
    "business": ALL_PACKS,
    "enterprise": ALL_PACKS,
    "staff": ALL_PACKS,
}
