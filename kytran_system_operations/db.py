...
def init_db(path):
    ...
    conn.execute("""CREATE TABLE IF NOT EXISTS subscriptions (
        ...
        tier TEXT NOT NULL DEFAULT 'free' CHECK(tier IN ('free', 'pro', 'business', 'enterprise', 'staff')),
    ...
    conn.execute("""CREATE TABLE IF NOT EXISTS compliance_remediations (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        scan_id TEXT NOT NULL,
        rule_id TEXT NOT NULL,
        pack_id TEXT,
    ...
    conn.execute("CREATE INDEX IF NOT EXISTS idx_remediation_scan ON compliance_remediations(scan_id)")
